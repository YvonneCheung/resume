export default {
  basicInfo: {
    ...
    work:
      '在工作中，我比较追求代码的规范性和高效可维护性。当更清晰的了解到业务功能后，我会先思考设计结构，而不是随意地就着手写页面。当然看着整洁的项目也能给我带来整理的快感。',
    university: '合肥师范学院',
    major: '计算机技术与科学',
    year: '2016',
  ...
  experience: [
    {
      ...
      detail: [
        ...
        },
        {
          ...
          content: [
            '重构项目目录结构，全局模块、组件封装等',
            '封装枚举值动态获取，封装导出下载方法简化代码',
            '根据产品需求对项目进行逻辑编写、前后端数据交互与开发',
